...
COPY ./src/ /go/src/portscan/src/
WORKDIR /go/src/portscan/src/
...
EXPOSE 8000
COPY --from=builder /go/src/portscan/src/portscanservice/portscanservice /app/portscanservice
WORKDIR /app
CMD ["./portscanservice"]
...
COPY --from=builder /go/src/portscan/src/portscan/portscan /app/portscan
WORKDIR /app
